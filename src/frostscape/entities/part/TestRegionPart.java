package frostscape.entities.part;
...
public class TestRegionPart extends RegionPart {
    public TestRegionPart(String region){
        super(region);
    }

    public TestRegionPart(String region, Blending blending, Color color){
