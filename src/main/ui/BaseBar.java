...
//A basic Bar class copied from Anuke's Bar which un-privates all Bar fields for subclasses. Use its subclasses or the regular bar.
public class BaseBar extends Element {
    ...
    public BaseBar(String name, Color color, Floatp fraction) {
    ...
    public BaseBar(Prov<CharSequence> name, Prov<Color> color, Floatp fraction) {
        this.fraction = fraction;
    ...
    public void reset(float value) {
        this.value = this.lastValue = this.blink = value;
    }
    ...
    public BaseBar outline(Color color, float stroke) {
    ...
    public BaseBar blink(Color color) {
        this.blinkColor.set(color);
        return this;
    }
