...
public class BouncyBulletType extends BaseBulletType {
    ...
    public void createUnits(Bullet b, float x, float y) {
        if (this.despawnUnit != null) {
            for(int i = 0; i < this.despawnUnitCount; ++i) {
                this.despawnUnit.spawn(b.team, x + Mathf.range(this.despawnUnitRadius), y + Mathf.range(this.despawnUnitRadius)).elevation = getHeight(b);
            }
        }
    ...
    public void despawned(Bullet b) {
        ...
        this.despawnEffect.at(b.x, b.y, b.rotation(), this.hitColor, height);
