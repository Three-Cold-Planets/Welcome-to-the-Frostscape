...
public class LightBeams implements SaveFileReader.CustomChunk {
    ...
    private static LightBeams light;

    public static LightBeams get(){
        if(light == null) return light = new LightBeams();
        return light;
    }
    ...
    public Vec2 furthestFalloffPoint(ColorData color, Vec2 position, float rotation){
        //Falloff should N E V E R. Be 0 in any of its fields. If it is, light should be disabled.
    ...
    /**
     * Finds the closest point away from the origin that a colour will fade to 0. Use {@link main.world.systems.light.LightBeams#furthestFalloffPoint} instead if finding furthest point.
     */
