package main.world.blocks.drill;
                    ...
                    for (int i = 0; i < drillHeads.length; i++) {
                        ...
                        if(!drill.drilling) {
                            ...
                            if (nextTarget != null) {
                                ...
                                drill.pos = MathUtils.moveToward(pos, Tmp.v1, headSpeed * warmup * Time.delta);
                            }
                        }
                        else{
                            if(drill.pos.within(drill.targetPos, 1)) {
                                ...
                                MathUtils.moveToward(drill.pos, drill.targetPos, headSpeed * warmup * Time.delta);
                            }
                            state = 0;
                        }
                ...
                case 1: {
                    ...
                    for(int i = 0; i < drillHeads.length; i++){
                        ...
                        if(!drill.retired) {
                            ...
                            drill.rotation += drill.rotationSpeed;
                            MathUtils.moveToward(drill.pos, Tmp.v1.set(0, 0), headSpeed * Time.delta);
